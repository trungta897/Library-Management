...
import { ArrowLeftRight, BookMarked, HelpCircle, LayoutGrid, Library, LineChart, LogOut, Pencil, Plus, Settings, Tags, Users } from "lucide-react";
...
const NAV_ITEMS = [
    ...
    { label: SIDEBAR.NAV_AUTHORS, icon: Pencil, href: "/admin/tac-gia" },
