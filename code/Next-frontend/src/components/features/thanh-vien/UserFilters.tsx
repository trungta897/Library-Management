    ...
    return (
        <div className="level-1-shadow flex flex-col items-center justify-between gap-md rounded-xl border border-outline-variant/30 bg-surface-container-lowest p-md md:flex-row">
            ...
            <div className="ai-border group relative w-full rounded-lg md:w-96">
                <Search className="absolute left-3 top-1/2 z-10 -translate-y-1/2 text-primary" size={20} />
                <input
                    className="h-[48px] w-full rounded-lg border-none bg-surface-bright/50 py-3 pl-10 pr-4 font-body-md text-body-md text-on-surface transition-all placeholder:text-outline/70 focus:outline-none focus:ring-0"
            ...
            <div className="hide-scrollbar flex w-full items-center gap-sm overflow-x-auto pb-2 md:w-auto md:pb-0">
                <div className="flex items-center gap-2 rounded-lg border border-outline-variant/50 bg-surface-container-low p-1">
                    <Filter className="px-2 text-outline" size={34} />
                    <select
                        aria-label="Role filter"
                        className="cursor-pointer appearance-none border-none bg-transparent py-1 pl-2 pr-8 font-body-sm text-body-sm text-on-surface outline-none focus:ring-0"
                    >
                ...
                <div className="flex items-center gap-2 rounded-lg border border-outline-variant/50 bg-surface-container-low p-1">
                    <select
                        ...
                        className="cursor-pointer appearance-none border-none bg-transparent py-1 pl-3 pr-8 font-body-sm text-body-sm text-on-surface outline-none focus:ring-0"
                    >
                ...
                <button
                    ...
                    className="flex items-center justify-center rounded-lg border border-outline-variant/50 bg-surface-container-low p-2 text-on-surface-variant transition-colors hover:bg-surface-variant hover:text-primary"
