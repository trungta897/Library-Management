...
export const BOOK_VISIT = {
    ...
    FORM: {
        ...
        SUCCESS_TITLE: "Đã ghi nhận lịch đến thư viện",
        SUCCESS_DESC: "Vui lòng kiểm tra email xác nhận trước khi đến quầy lễ tân.",
        TOAST_SENDING: "Đang gửi xác nhận lịch đến...",
        TOAST_SUCCESS: "Đã gửi xác nhận lịch đến email của bạn.",
        TOAST_EMAIL_NOT_CONFIGURED: "Đã ghi nhận lịch đến. Email xác nhận hiện chưa thể gửi tự động.",
        TOAST_ERROR: "Không thể gửi xác nhận qua email. Vui lòng thử lại sau.",
        CLOSE_TOAST: "Đóng thông báo",
    },
    INFO: {
        ...
        BRANCH: "Lumina Central",
        ADDRESS_LINE_1: "1440 Knowledge Ave.",
        ADDRESS_LINE_2: "Innovation District, CA 90210",
        WEEKDAY_LABEL: "Thứ 2 - Thứ 6",
        WEEKDAY_TIME: "08:00 - 22:00",
        WEEKEND_LABEL: "Thứ 7 - Chủ nhật",
        WEEKEND_TIME: "10:00 - 20:00",
