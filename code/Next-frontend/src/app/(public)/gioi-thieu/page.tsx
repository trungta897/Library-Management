    ...
    <main className="flex-grow">
      ...
      <section className="relative min-h-[614px] flex items-center justify-center overflow-hidden py-12">
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6 text-center">
          <h1 className="mb-4 text-5xl font-bold leading-[56px] tracking-[-0.02em] text-primary">
            Khai sáng tri thức bằng AI
          </h1>
          <p className="mx-auto mb-6 max-w-3xl text-xl font-semibold leading-7 text-on-surface-variant">
          ...
          <button
            className="ai-glow mx-auto inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-secondary px-12 py-4 text-xl font-semibold leading-7 text-on-primary shadow-lg transition-opacity hover:opacity-90 active:scale-95"
            type="button"
          >
      ...
      <section className="bg-surface-container-low py-12">
        <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-12 px-6 md:flex-row">
          <div className="order-2 flex-1 md:order-1">
            <div
              className="aspect-video w-full rounded-lg bg-cover bg-center shadow-[0_12px_32px_rgba(0,0,0,0.1)]"
              style={{
                backgroundImage:
          ...
          <div className="order-1 flex-1 md:order-2">
            <h2 className="mb-4 text-[32px] font-semibold leading-10 tracking-[-0.01em] text-primary">
              Câu chuyện của chúng tôi
            </h2>
            <p className="mb-4 text-base leading-6 text-on-surface-variant">
      ...
      <section className="py-12">
        <div className="mx-auto max-w-[1440px] px-6">
          <div className="mb-12 text-center">
            <h2 className="mb-2 text-[32px] font-semibold leading-10 tracking-[-0.01em] text-primary">
              Giá trị cốt lõi
            </h2>
            <p className="text-base leading-6 text-on-surface-variant">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {/* Value 1 - Innovation */}
            <div className="flex flex-col items-start rounded-lg border border-outline-variant/20 bg-surface p-6 shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-shadow duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.1)] md:translate-y-4">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded bg-primary-container text-on-primary-container">
                <span
              ...
              <h3 className="mb-1 text-xl font-semibold leading-7 text-on-surface">
                Đổi mới
              </h3>
            ...
            <div className="flex flex-col items-start rounded-lg border border-outline-variant/20 bg-surface p-6 shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-shadow duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.1)] md:translate-y-4">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded bg-secondary-container text-on-secondary-container">
                <span
                  className="material-symbols-outlined"
                  style={{
                    fontVariationSettings: "'FILL' 1",
            ...
            {/* Value 3 - Integrity */}
            <div className="flex flex-col items-start rounded-lg border border-outline-variant/20 bg-surface p-6 shadow-[0_4px_12px_rgba(0,0,0,0.05)] transition-shadow duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.1)] md:translate-y-4">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded bg-tertiary-container text-on-tertiary-container">
                <span
                  className="material-symbols-outlined"
                  style={{
                    fontVariationSettings: "'FILL' 1",
