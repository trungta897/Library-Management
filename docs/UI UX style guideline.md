...
### 2.2. Màu phụ (Secondary — Cyan & Tertiary — Purple)

Tông màu thứ cấp tạo điểm nhấn và báo hiệu sự tương tác.

| Token           | Hex       | Sử dụng                  |
| --------------- | --------- | ------------------------ |
| `secondary-50`  | `#e0f7fa` | Background phụ           |
| `secondary-300` | `#4dd0e1` | Highlight / Progress     |
| `secondary-500` | `#00aeef` | **Interactive, Links**   |
| `tertiary-300`  | `#b388ff` | AI Gradient Point        |
| `tertiary-500`  | `#8a2be2` | **Deep Purple (AI)**     |
...
| --------------- | ----------------------------------- | --------------------------- |
| **Primary**     | Hành động chính, nền màu Primary    | "Đặt mượn sách", "Xác nhận" |
| **Secondary**   | Hành động phụ, nền xám nhạt         | "Hủy", "Quay lại"           |
| **Inverted**    | Nền đen/tối màu, chữ sáng           | "Thao tác đặc biệt"         |
| **Outlined**    | Nền trong suốt, có viền bao quanh   | "Xem thêm", "Lọc"           |
| **Destructive** | Hành động nguy hiểm                 | "Xóa sách", "Hủy phiếu"     |
| **Icon Button** | Dạng tròn/vuông hoặc hình pill chứa icon | Nút xoá, chỉnh sửa, tags    |
